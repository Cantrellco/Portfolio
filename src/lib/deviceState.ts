...
// Devices start hidden — the hero is a pure dashboard; the flagship scan
// screen materializes them.
export const deviceState = {
  phone: { x: 2.1, y: -0.4, z: 0, rx: 0.04, ry: -0.24, rz: -0.04, scale: 0.001 } as DevicePose,
  watch: { x: 3.7, y: -1.3, z: 0.6, rx: 0.12, ry: -0.5, rz: 0.06, scale: 0.001 } as DevicePose,
